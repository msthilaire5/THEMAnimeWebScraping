...
from scraping.populate_review_db import get_anime_AKA
from scraping.MissingAnimeDetailError import MissingAnimeDetailError


class get_anime_AKA_TestCase(unittest.TestCase):
    ...
    def test_title_missing(self, mock_get):
        ...
        with self.assertRaises(MissingAnimeDetailError):
            title = get_anime_AKA(review_link)
            mock_get.assert_called_with("tests/example_pages/no_aka.html")
